...
//  lowkey not sure what this is for      appBarConfiguration = AppBarConfiguration(navController.graph, drawerLayout)


        // unlock the drawer when we are at start destination
